...
export default function MainPage() {
    ...
    return (
        ...
        <Box
            ...
            sx={{ margin: 4, padding: 4, border: '1px solid #ccc', borderRadius: 10, boxShadow: 3 }}
        >
            ...
            >
                ...
                <Paper elevation={3} sx={{ padding: 4, borderRadius: 10 }}>
            ...
            <Box
                ...
                sx={{
                    ...
                    px: 2, // padding horizontally
                    width: '100%',
                    textAlign: 'center'
                }}
            >
                <Typography variant="body2" color="text.secondary">
                    © {new Date().getFullYear()} Investing Hub. All rights reserved.
                </Typography>
            </Box>
